    ...
    <div className="h-full flex flex-col space-y-6 pb-24 md:pb-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and track all your contracts</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-12 text-center">
        <FileSignature className="mx-auto text-slate-300 mb-4" size={64} />
        <h3 className="text-xl font-semibold text-slate-900 mb-2">No Contracts Yet</h3>
        <p className="text-slate-500 mb-6">Get started by creating your first contract</p>
