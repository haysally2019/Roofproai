        ...
        if (currentUser?.companyId) {
            ...
            try {
                await updateCompany({
                    ...
                    name: form.companyName || 'My Company',
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
       <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden flex flex-col">
                ...
                <div className="animate-fade-in space-y-6 text-center">
                   ...
                   <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 text-left mt-6">
                      ...
                      <ul className="space-y-2 text-slate-600">
                         <li className="flex items-center gap-2"><div className="w-5 h-5 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center text-xs font-bold">1</div> Import your existing leads</li>
                         <li className="flex items-center gap-2"><div className="w-5 h-5 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center text-xs font-bold">2</div> Set up your price book</li>
                         <li className="flex items-center gap-2"><div className="w-5 h-5 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center text-xs font-bold">3</div> Connect your email</li>
                      </ul>
                   </div>
                </div>
             )}
          ...
          <div className="p-8 bg-slate-50 border-t border-slate-200 flex justify-end">
             <button
                onClick={handleNext}
                disabled={(step === 1 && !form.companyName) || saving}
                className="px-8 py-3 bg-blue-600 text-white rounded-xl font-bold text-lg hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 flex items-center gap-2 disabled:opacity-50 disabled:shadow-none"
             >
                {saving ? (
